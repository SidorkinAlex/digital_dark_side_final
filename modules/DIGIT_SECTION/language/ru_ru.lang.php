...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Участок Список',
  'LBL_MODULE_NAME' => 'Участок',
  'LBL_MODULE_TITLE' => 'Участок',
  'LBL_HOMEPAGE_TITLE' => 'Мой Участок',
  'LNK_NEW_RECORD' => 'Создать Участок',
  'LNK_LIST' => 'View Участок',
  'LNK_IMPORT_DIGIT_SECTION' => 'Импорт Участок',
  'LBL_SEARCH_FORM_TITLE' => 'Найти Участок',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Просмотр истории',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Мероприятия',
  'LBL_DIGIT_SECTION_SUBPANEL_TITLE' => 'Участок',
  'LBL_NEW_FORM_TITLE' => 'Новый Участок',
    'LBL_DIGIT_SECTION_USERS_REL_TITLE' => 'Исполнители (Связь)',
    'LBL_DIGIT_SECTION_USERS_SUBPANEL_TITLE' => 'Исполнители',
);