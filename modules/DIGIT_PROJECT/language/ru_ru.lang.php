...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Проекты Список',
  'LBL_MODULE_NAME' => 'Проекты',
  'LBL_MODULE_TITLE' => 'Проекты',
  'LBL_HOMEPAGE_TITLE' => 'Мой Проекты',
  'LNK_NEW_RECORD' => 'Создать Проекты',
  'LNK_LIST' => 'View Проекты',
  'LNK_IMPORT_DIGIT_PROJECT' => 'Импорт Проекты',
  'LBL_SEARCH_FORM_TITLE' => 'Найти Проекты',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Просмотр истории',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Мероприятия',
  'LBL_DIGIT_PROJECT_SUBPANEL_TITLE' => 'Проекты',
  'LBL_NEW_FORM_TITLE' => 'Новый Проекты',

  'LBL_DATE_START' => 'Дата начала',
  'LBL_DATE_STOP' => 'Дата завершения',
  'LBL_DATE_ATTENTION' => 'Дата повышенной готовности',
  'LBL_PROJECT_STATUS' => 'Статус',
  'LBL_PRIORITY' => 'Приоритет',
  'LBL_DATE_STOP_LAST_TASK' => 'Дата завершения последней задачи',
  'LBL_PROJECT_STARTER_ID' => 'Инициатор проекта ID',
  'LBL_PROJECT_STARTER_NAME' => 'Инициатор проекта',
);